...
export default function OverviewTab({ liveWatts, todayUnits, thisMonthUnits, monthChange, bill, gamification, chartData, chartKey, chartView, setChartView }) {
    return (
        <>
            ...
            <div className="dash-overview-top">
                ...
                <div className="dash-stats-grid">
                    ...
                    <StatCard label="This Month" value={thisMonthUnits.toFixed(0)} unit="kWh" trend={monthChange} />
                    <StatCard label="Est. Bill" value={`₹${bill.total.toLocaleString('en-IN')}`} unit="" />
                    <StatCard label="XP" value={gamification.xp} unit={`Lvl ${gamification.level}`} />
                </div>
            </div>
