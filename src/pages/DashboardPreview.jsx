...
const mockUser = { id: '1', name: 'Archie Tyagi', email: 'archietyagi100@gmail.com', state: 'Delhi', householdSize: 4, tariffPlan: 'Residential', xp: 850, level: 5, createdAt: '2026-03-15' };
...
const mockGamification = {
    ...
    challenges: [
        { id: 1, name: 'Archie Tyagi', description: 'Use under 150 kWh', target: 150, progress: 108, unit: 'kWh' },
